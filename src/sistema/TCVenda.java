 ...
 * @author isaqu
 */
public class TCVenda extends javax.swing.JFrame {

    /**
     * Creates new form TCVenda
     */
    public TCVenda() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TCVenda.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
